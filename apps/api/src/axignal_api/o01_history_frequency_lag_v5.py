...
def run_campaign(plan_path: Path, output_dir: Path) -> dict[str, Any]:
    ...
    if plan["schema_version"] != "axignal.o01-history-frequency-lag-plan/v0.4":
    ...
    legacy.write_json(
        ...
        {
            "schema_version": "axignal.o01-official-source-observations/v0.5",
            "status": "PASS",
            "documents": official,
    ...
    legacy.write_json(
        ...
        {
            "schema_version": "axignal.o01-release-calendar-observations/v0.5",
            "status": "PASS",
            "parser": "xlrd==2.0.2",
    ...
    result = {
        "schema_version": "axignal.o01-history-frequency-lag-result/v0.5",
