...
Status: `v1.4-global-e2e-candidate`
Goal ID: `AXIGNAL-GOAL-001`

These documents are normative specifications for AXIGNAL. Contract 30 governs the active development programme and no-partial-launch rule. Contracts 00–29 remain applicable capability contracts and evidence where they do not weaken Contract 30.

## Contract set

| Contract | Purpose |
|---|---|
| [00 — Product Constitution](00-product-constitution.md) | Mission, boundaries and invariants |
| [01 — Business Model and Pricing](01-business-model-and-pricing.md) | Buyer, value and commercial hypotheses |
...
| [21 — Marketing Site and Conversion](21-marketing-site-and-conversion.md) | Landing and conversion |
| [22 — Packaging, Pricing and Entitlements](22-packaging-pricing-and-entitlements.md) | Plans and economics |
...
| [28 — B2G Procurement Commercial and Global Source Program](28-b2g-procurement-commercial-and-global-source-program.md) | Procurement-specific commercial and source rules retained under Contract 30 |
...
- [`data/libraries/global-opportunity-library-registry.v1.4.json`](../../data/libraries/global-opportunity-library-registry.v1.4.json)

## Supersession

Contract 30 supersedes conflicting programme order and partial-launch interpretations. It does not erase accepted technical evidence or source-specific safety rules.
