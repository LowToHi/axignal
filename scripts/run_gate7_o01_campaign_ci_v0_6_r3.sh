...
jq -e \
  '.schema_version == "axignal.o01-real-campaign-execution-request/v0.6-r3" and
...
cp \
  apps/api/src/axignal_api/o01_quality_stage_timing_v2.py \
  apps/api/src/axignal_api/o01_quality_stage_timing.py
cp \
  apps/api/tests/test_o01_quality_stage_timing_v2.py \
