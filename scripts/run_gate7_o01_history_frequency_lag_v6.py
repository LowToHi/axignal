...
from axignal_api.o01_history_frequency_lag_v6 import run_campaign
from axignal_api.o01_quality_common import O01QualityCampaignError


def main() -> int:
    parser = argparse.ArgumentParser(
        description="Execute the effective-authority AX-LIB-O01 O01-E campaign"
    )
    ...
    try:
        ...
        failure = {
            "schema_version": "axignal.o01-history-frequency-lag-failure/v0.6",
            "status": "FAIL",
