...
from axignal_api.gate7_o01_runtime import run_campaign_v0_3
...
def failure_payload(
    ...
    *,
    ...
    payload: dict[str, object] = {
        "schema_version": "axignal.o01-campaign-failure/v0.3",
        "status": "FAIL",
    ...
    if "TED returned HTTP " in str(exc):
        ...
        try:
            payload["ted_diagnostic_probe"] = diagnose_frozen_first_request(plan_path)
...
def main() -> int:
    ...
    try:
        ...
        failure = failure_payload(exc, plan_path=args.plan, raw_dir=args.raw_dir)
        args.output_dir.mkdir(parents=True, exist_ok=True)
        failure_path = args.output_dir / "campaign-failure.v0.3.json"
