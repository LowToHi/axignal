...
def main() -> None:
    ...
    assert "Status: `CLOSED / PASS`" in contract
    for marker in (
    ...
    print("AXENT_PERSISTENCE_AND_TENANT_ISOLATION_PASS")
    print("AXENT_GROUNDED_KNOWLEDGE_PASS")
    print("AXENT_SERVER_AUTHORITY_CONTEXT_PASS")
    print("AXENT_READ_ONLY_SUPPORT_E2E_PASS")
    print("AXENT_BOUNDED_TOOL_EXECUTION_PASS")
    print("AXENT_CONSENTED_CUSTOMER_ACTIONS_PASS")
    print("AXENT_HUMAN_ESCALATION_ROUND_TRIP_PASS")
    print("AXENT_SUPPORT_SECURITY_AND_RELIABILITY_PASS")
