...
MANIFEST = (
    ...
    "AX-LIB-O01-campaign-authority-manifest.v0.2.json"
)
CONTRACT = (
    ROOT
...
PRIOR_PLAN = (
    ROOT
    / "data/acceptance/campaigns/"
    "AX-LIB-O01-real-quality-coverage-lag-plan.v0.1.json"
)

MANIFEST_REF = (
    "sha256:e608b2d464c005aab5efff6f2e9689b7cd29c78941a1f45336eab91b87d58de6"
)
CONTRACT_REF = (
    "sha256:f86672f2925343fccc61ebe0cb1085a470bbb54d062f1f936eed9347854ff3a3"
)
PRIOR_PLAN_REF = (
    "sha256:7d323a9a920f1fe96832b5f6e631b4da257c3ce995ef433705aff95c3ed1643b"
)
PRIOR_ARTIFACT_REF = (
    "sha256:6a3d55557d16459e546839a6170db02e618b3a4c31cfadf6761a0d2885dab47f"
)
PRIOR_RESULT_REF = (
    "sha256:0d5c88da9f48371a754d58486ef4a738be67a8c76fcae953d6055767b91475df"
)
TARGET_HEAD = "63b210b12988b26be04abed3701f8d97ffccebad"
TARGET_TREE = "2d02c1d616516a14168b6c378d2d3352d2750da2"
QUERY_PREFIX = (
    "buyer-country IN ({country}) AND publication-date >= 20260701 "
    "AND publication-date <= 20260731 SORT BY publication-number"
)
QUERY_FROM = QUERY_PREFIX + " ASC"
QUERY_TO = QUERY_PREFIX
...
def main() -> int:
    ...
    assert manifest["campaign_id"] == (
        "AX-LIB-O01-TED-QALAG-ML-CONTROLS-v0.2"
    )
    ...
    assert remediation["prior_result_member_sha256"] == PRIOR_RESULT_REF
    ...
    assert (
        contract["source"]["authentication"]
        == prior["source"]["authentication"]
    )
