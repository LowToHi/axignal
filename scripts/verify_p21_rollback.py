...
PLAN_PATH = ROOT / "data/commercial/p21-rollback-plan.v0.1.json"
...
before = {
    ...
    for relative_path in plan["preserved_p20_authority_files"]
}

for relative_path in plan["p21_only_artifacts"]:
    ...
    json.dumps(
        {
            ...
            "removed_p21_artifacts": len(plan["p21_only_artifacts"]),
            "restored_baseline_files": len(plan["restored_baseline_files"]),
            "preserved_p20_authority_files": len(before),
